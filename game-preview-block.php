<?php
/*
Plugin Name: Saintsmedia plugin
Plugin URI: https://yourwebsite.com/
Description: Многофункциональный плагин на основе Carbon fields
Version: 2
Author: Semtio
*/
...
{
    // Генерируем уникальный ID для каждого экземпляра шорткода
    static $instance_counter = 0;
    $instance_counter++;
    $instance_id = 'table-block-' . $instance_counter;
